...
function Main() {
    ...
    React.useEffect(() => {
        const sumWidth = activeItems.length * 200;

        const newHasRightScroll = sumWidth > ref.current.offsetWidth;
        setHasRightScroll((currentHasRightScroll) => newHasRightScroll !== hasRightScroll ? newHasRightScroll : currentHasRightScroll);
    }, [activeItems]);
    ...
    return <main className="main">
        ...
        <section className="section main__devices">
            ...
            <div className="section__panel-wrapper" ref={ref}>
                <div key={activeTab} role="tabpanel" className={'section__panel'} aria-hidden={activeTab === activeTab ? 'false' : 'true'} id={`panel_${activeTab}`} aria-labelledby={`tab_${activeTab}`}>
